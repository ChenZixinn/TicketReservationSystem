...
public class GlobalExceptionHandler {
    ...
    public Object handlerException(Exception e){
        ...
        return ApiRestResponse.error(TicketSystemExceptionEnum.SYSTEM_EXCEPTION);
    }
    ...
    @ResponseBody
    public Object handlerException(TicketSystemException e){
        log.error("TicketSystemException: ", e);
    ...
    private ApiRestResponse handlerBindingResult(BindingResult result){
        ...
        if (list.size() == 0){
            throw new TicketSystemException(TicketSystemExceptionEnum.REQUEST_PARAM_ERROR);
        }
        return ApiRestResponse.error(TicketSystemExceptionEnum.REQUEST_PARAM_ERROR.getCode(), list.toString());
    }
}
